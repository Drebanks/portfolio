    ...
    <div className={classes.container}>
      ...
      <div className={classes.over}>
        ...
        <blockquote className={classes.block}>
          <span>
            ...
            Though the concept is novel, it’s here to
            <br />
            stay, as Nigeria’s millennial (youth) population currently accounts
            for about 440 million of her population.
          </span>
        </blockquote>
      </div>
      ...
      <div className={classes.discover}>
        ...
        <p className={classes.live}>
          Make living with roommates a more positive, clean, and transparent
          experience. We created Happyco to address the pains and gains of
          sharing a space and to generate more positive interactions between
          roommates. It was easy for us to empathize with our users because we
          both had many of these shared experiences. Being located in Barcelona,
          a city full of young professionals and students living on a budget, we
          easily identified and acquired users for surveys, interviews, and user
          testing.
        </p>
        <p>Ideation</p>
        <p className={classes.idea}>
          After a few days at the drawing board and a million post-its later, we
          derived our hypothesis and started conducting quantitative and
          qualitative interviews. One of my favorite UX/UI processes was
          ideating and brainstorming. It was incredible to see how collaborative
          my teammates were. It was invigorating to let ideas flow without the
          fear of judgement or rejection. Every idea played an essential role in
          forming the next and there was no such thing as a bad idea in this
          stage. To me that was a beautiful process. I was also very impressed
          by my ability and confidence to express my ideas and feedback.
        </p>
        <img src={Board} alt="" />
      </div>
      ...
      <div className={classes.facts}>
        ...
        <div className={classes.cast}>
          <div className={classes.look}>
            <p>
              Looking at India, with 34% of the country’s Millennials as a % of
              total Indian population within the age bracket of 18–35 years, it
              is THIS demographic group or Indian millennials that already are,
              and will continue to drive the consumption story across sectors,
              including real estate.
            </p>
          </div>
          <div className={classes.look}>
            <p>
              In the context of residential real estate, millennials will not
              only drive but also redefine the manner in which it is consumed
              due to their inherent need for mobility, connectivity and
              tech-enabled living spaces. Plug it and play with it, just like
              flexible office space environments, is where the Gen Y housing
              needs are headed.
            </p>
          </div>
        </div>
        <div className={classes.cast}>
          <div className={classes.look}>
            <p>
              As per recent research, India’s millennial population is expected
              to grow from 28% of the total population in 2016 to an estimated
              42% of the total population by 2025.
            </p>
          </div>
          <div className={classes.look}>
            <p>
              Over 50% of people in the age group of 18–35 years are willing to
              rent co-living spaces and pay up to Rs 15,000 a month in top
              Indian cities including Delhi NCR, Mumbai and Bengaluru.
            </p>
          </div>
        </div>
        <div className={classes.cast}>
          <div className={classes.look}>
            <p>
              Millennial space utilisation patterns show that they typically
              spend more than nine hours a day in the bedroom and bathroom areas
              that occupy about 40 % of the total apartment space.
              Interestingly, the hall, kitchen, and utility areas — that
              constitute 60% of the apartment space and cost — are utilised for
              less than three hours daily.
            </p>
          </div>
          <div className={classes.look}>
            <p>
              While the concept of community living is far from novel, what
              draws millennials together in co-living spaces is their lifestyle
              choices. There are barbeque parties, movie nights, board games,
              sumptuous brunches, and more to keep the space buzzing with
              energy. It’s no surprise that the occupancies are as high as
              95–100 per cent
            </p>
          </div>
        </div>
      ...
      <div className={classes.analysis}>
        ...
        <p className={classes.ana}>
          We performed benchmarking research to identify our competitors. Our
          biggest competitors were:
        </p>
        ...
        <p className={classes.ana}>
          We analyzed their key functions, usability, and aesthetics. We
          realized many of these applications were outdated and had poor
          usability. There was a need for a more modernized and minimalist
          service that was easy to use. Our ultimate goal was to organize
          cleaning in a friendly and diplomatic manner, hence the name Happyco.
          Additionally, our stakeholders map revealed many potential partnership
          opportunities with companies such as Badi, Idealista, and other
        ...
        <br />
        <p className={classes.ana}>
          After reviewing our results, we found our target users. We identified
          users (ages 18–35) who had lived with roommates for over one year. We
          prepared two surveys (an English and Spanish version) on Survey
          Monkey. We distributed the surveys across a variety of channels, such
          as Facebook groups, Slack, WhatsApp, and Instagram. We received over
          80 responses in both English and Spanish.
          <br />
          <br />
          The purpose of the survey was to learn principle frustrations,
          motivations, and pre-existing household management systems of our
          potential users. Our survey findings allowed us to better direct and
          focus our questions during interviews.
        </p>
        <br />
        <br />
        <br />
        ...
        <br />
        <p className={classes.ana}>
          Many of the responses to Question #4 revealed that majority of people
          did household chores that were not their responsibility 2–3 times in
          two weeks. We then conducted qualitative interviews with our potential
          users. We wanted to understand the users experiences and conceptions
          of shared living and qualitative methods allowed us to discuss more
          personal experiences.
          <br />
          <br />
          We conducted interviews in both Spanish and English, which widened our
          perspective and potential user pool. We found many of users shared
          apartments with a variety of nationalities, which also showed the need
          for simplistic organization and communication channels.
        </p>
        <br />
        <h1>Key Discoveries</h1>
        <br />
        <p className={classes.ana}>
          Our findings revealed that many of our potential users had conflict
          about cleaning and organization. We also discovered many shared
          similar social and economical motivations for sharing a space.
        </p>
        <br />
        ...
        <ul className={classes.ana}>
          <li>
            People live with friends and strangers because they want to save
            money while living in central and trendy locations
          </li>
          <li>
            People like the social aspects of sharing spaces and having people
            to share life with (i.e coming home from work and having someone to
            talk to or cook with).
          </li>
        </ul>
        <br />
        ...
        <ul className={classes.ana}>
          <li>
            Lack of cleanliness in common areas (similar to the tragedy of the
            commons — my social sciences side coming out)
          </li>
        ...
        <ul className={classes.ana}>
          <li>
            WhatsApp was the most common way people communicated with their
            roommates, organized cleaning, and coordinated schedules
          </li>
          <li>
            One person is usually in charge of rent, bills, and communicating
            with management and other roommates if there is a problem
          </li>
        </ul>
      </div>
      ...
      <div className={classes.map}>
        ...
        <p className={classes.ana}>
          ...
          comprehending all of it, we composed our thoughts and decided that our
          product needs to based on the 3Cs and highlighting them throughout the
          product. The 3Cs are mentioned next.
        </p>
        ...
        <div className={classes.visual}>
          ...
          <br />
          <p className={classes.ana}>
            Sketching an outline of the app was a way to help us visualize it.
            is the process where you generate ideas and solutions.
          </p>
          <img src={Sketch} alt="" />
          <br />
        </div>
        <div className={classes.wire}>
          ...
          <br />
          <p className={classes.ana}>
            Low-fidelity wireframes provide a simple picture by way of
            organizing blocks that show space allocated for an image and mock
            content used to get a rough idea of the different content blocks. We
            based our wireframes on a user flow map, which helped us be more
            focused on what the low-fi wireframes we had to do. This was the
            first time we worked on low-fi wireframes and we struggled to keep
            it simple!
          </p>
          <br />
          <br />
        ...
        <br />
        <p className={classes.ana}>
          We wanted our app to look happy yet reliable, so we went for blue as
          our main color. According to Color Theory in Action, blue is often
          associated with depth and stability. It symbolizes trust, loyalty,
          wisdom, confidence, intelligence, faith, truth, and heaven. Blue is
          considered beneficial to the mind and body.
          <br />
          <br />
          Regarding typography, we used Inter Typeface, a free and open source
          font family designed by Rasmus Andersson. Inter is designed for
        ...
        <br />
        <p className={classes.ana}>
          With our user flow in mind, we used FIGMA to design our prototype. Our
          goal was to create a wholesome product that introduces the concept of
          co-living, while giving the user access to all the functionalities
          right from exploring, booking to verification, viewing scheduled
          community events, brand benefits to relocating amongst other
          facilities or ending his tenure with the brand.
        </p>
        <br />
        <br />
        <h1>Onboarding</h1>
        <br />
        <p className={classes.ana}>
          The home page was designed and structured in a way that the users get
          an idea about the concept of Co-living spaces, why’d they go with the
          brand, the typical assurance and pitch flow. At the same time, it’s
        ...
        <br />
        <p className={classes.ana}>
          Testing revealed that our app was easy to use with a few minor
          discrepancies. After completing various tasks for our on-boarding, our
          users had trouble with confirming they had submitted their
          information. We added a confirmation pop-up so users knew they had
          successfully completed a task.
          <br />
          <br />
          It further revealed that various functions in our chat were not
          needed. For example, we originally had a payment option in our chat
          but our users brought up security concerns so we decided to delete
          this function to ensure credibility.
        </p>
        <h1>Future Improvements</h1>
        <br />
        <p className={classes.ana}>
          There is always room for improvement, however it is important to share
          what you have, recieve feedback, and try again. I anticipate more
          edits and final touches to our design and in the future we would like
          to:
        </p>
        <br />
        <ul className={classes.numb}>
        ...
        <br />
        <p className={classes.ana}>
          I love the multidisciplinary nature of UX/UI Design. One moment you
          are conducting market research, the next you are conducting user
          interviews, and then designing prototypes. It truly allows you to use
          all sides of your brain and to use human empathy and psychology to
          create a product that will hopefully make peoples lives easier. The
          development process of Happyco gave me many insights into the world of
          UX/UI and I was excited at every stage. Now we just to build our code
          and maybe enroll in a coding bootcam. Please feel free to provide
